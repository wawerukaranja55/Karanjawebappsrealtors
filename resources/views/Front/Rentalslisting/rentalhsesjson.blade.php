    ...
    @else 
        ...
        <div class="col-lg-6 col-md-6">
            ...
            <div class="card card-list" style="box-shadow: 0px 0px 7px 3px #d3b8b8;">
                ...
                @endif
                <img class="card-img-top" src="{{ asset ('imagesforthewebsite/rentalhouses/rentalimages/medium/'.$rentalhse->rental_image) }}" alt="{{ $rentalhse->rental_name }}" style="height: 220px; box-shadow: 0px 0px 7px 3px #b1adad;">
                <div class="card-body">
                    ...
                    <h2 class="text-dark mb-0 mt-3">
                        sh.{{ $rentalhse->monthly_rent }} <small>/month</small></h2>
                </div>
                <div class="card-footer">
                    <section style="display: flex;
                    justify-content: space-between; padding:2px; margin-bottom:5px;">
                        <div class="name-icon">
