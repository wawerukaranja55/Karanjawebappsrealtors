...
@section('title','Active/Published Rental Houses')
@section('content')
...
<h3 class="mb-2 panel-title ms_heading text-white bg-black" style="padding:10px;">Actived Rental Houses</h3>
<div class="row" style="margin-top: 10px;">
   <div class="col-lg-10 mx-auto">
      <table id="activerentalstable" class="table table-striped table-bordered" style="width:100%; margin-top:50px;">
         <thead>
           <tr>
             <td>id</td>
             <td>Rental Name</td>
...
@section('activehsesmgmtscript')
  <script>


      // show activated houses of the house in a datatable
      var activerentalhousestable = $('#activerentalstable').DataTable({
         processing:true,
         serverside:true,
         responsive:true,

         ajax:"{{ route('get_activerentals') }}",
         columns: [
            { data: 'id' },
            { data: 'rental_name' },
            { data: 'monthly_rent' },
            ...
            { data: 'rental_image',
               ...
               return "<img src=\"/imagesforthewebsite/rentalhouses/rentalimages/small/" + data + "\" height=\"80px\" height=\"80px\"/>"
               }
            }, 
            { data: 'rental_status',
         ...
         $(document).on('change','.rentalhsestatus',function(e)
         {
            ...
            $.ajax({
                  type:"GET",
                  dataType:"json",
                  url:'{{ route('updaterentalhse.status') }}',
                  data:{
                     'status':hsestatus,
                     'id':rentalhseid
                  },
