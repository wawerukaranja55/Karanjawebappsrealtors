...
<head>
    ...
    <meta charset="UTF-8">
    <title>Total Payments For A Tenant</title>
    <style>
            ...
            <div class="header">
                ...
                <div class="bill_total_wrap">
                    <div class="bill_sec">
                        ...
                        <span>
                            Name:{{ $userinfor->name }}<br/>
                            Phone Number:{{ $userinfor->phone }}<br/>
                           Id Number:{{ $userinfor->id_number }}<br>
                            Rooms:@foreach ($userinfor->hserooms as $room )
                                {{ $room->room_name }},
                            @endforeach
                        </span>
                    </div>
                ...
                <div class="main_table">
                    <div class="table_header">
                        <div class="row">
                            ...
                            <div class="col col_arrears">Arrears</div>
                            <div class="col col_overpayment">Over_Payment</div>
                        </div>
                    </div>
                    <div class="table_body">
                        @foreach ($viewuserpayments as $userpayment)
                            <div class="row">
                                <div class="col col_no">
                                    <p>{{ $userpayment->id }}</p>
                                </div>
                                <div class="col col_hse">
                                    <p class="bold">{{ $userinfor->rentalhses->rental_name }}</p>
                                    <p>@foreach ($userinfor->hserooms as $room )
                                        {{ $room->room_name }},
                                    @endforeach</p>
                                </div>
