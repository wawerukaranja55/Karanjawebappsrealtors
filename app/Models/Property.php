...
class Property extends Model
{
    ...
    protected $fillable = ['property_name','propertylocation_id','property_address','propertycat_id','property_image','property_video','property_details','property_price','property_isactive','property_isavailable'];
