...
class Rental_house extends Model
{
    ...
    protected $fillable = ['rental_name','monthly_rent','rental_image','rental_video','rental_details','rentalcat_id','rental_status','location_id','total_rooms','tagimages_status','parking','cctv_cameras','servant_quarters','waterbill','electricitybill','balcony','vacancystatus','wifi'];
