...
class Rentalhouses_controller extends Controller
{
    ...
    public function activerentalhses(Request $request)
    {
    ...
    public function get_activerentals(Request $request)
    {
        ...
        return view('Admin.Rental_houses.activatehouses',compact('activerentals'));
    }
    ...
    public function addrentalhse()
    {
        ...
        return view('Admin.Rental_houses.addrentalhouses',compact('allrentaltags','allvacancystatus','allrentallocations','allrentalcategories'));
    }
    ...
    public function addalternateimages(Request $request,$id)
    {
        ...
        $rentaldata=Rental_house::with('rentalalternateimages','housetags')->select('id','rental_name','location_id','rental_image','total_rooms')->find($id);
    ...
    public function store(Request $request)
    {
        ...
        $custommessages=[
            ...
            'total_rooms.required'=>'Enter The number of total rooms in the houses',
            'monthly_rent.required'=>'Enter The monthly price rent for the house',
            'monthly_rent.numeric'=>'Enter a Valid Amount',
            'rental_details.required'=>'Write the house descritions',
        ...
        $rental_house->is_vacancy=$data['rentalhousevacancy'];
